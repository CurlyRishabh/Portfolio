...
const LinkButton = ({href, text}) => (
	<a href={href} target="_blank">
		<button className="bg-blue-800 w-20 h-10 font-bold text-xl text-white rounded-md">{text}</button>
	</a>
);
...
function List(props){
    return (
		<div className="flex flex-col md:flex-row gap-6">
			<img className="md:h-56 border-8 border-slate-500 rounded-lg" src={props.src} alt="Img" />
